    ...
    <form action={action} className="adm-form">
      ...
      <div className="adm-field__row--3">
        <label className="adm-field">
          ...
          <input name="delivery_min_days" type="number" min={1} max={60} step={1} className="adm-field__input" placeholder="e.g. 5" />
        </label>
        <label className="adm-field">
          <span className="adm-field__label">Delivery · max days</span>
          <input name="delivery_max_days" type="number" min={1} max={60} step={1} className="adm-field__input" placeholder="e.g. 7" />
        </label>
